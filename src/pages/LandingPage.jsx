    ...
    <>
     ...
     <div className="container border border-2 rounded border-secondary p-5 mt-5 mb-5">
        <Row>
          ...
          <Col></Col>
          <Col lg={6}>
   <iframe width="640" height="360" src="https://www.youtube.com/embed/QdBZY2fkU-0" title="Grand Theft Auto VI Trailer 1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          </Col>
        </Row>
     </div>
    </>
